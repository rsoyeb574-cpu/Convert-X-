...
const FORMAT_DESCRIPTIONS: Record<string, { label: string; subtext: string; icon: string }> = {
  ...
  ply: { label: 'PLY', subtext: 'Polygon Mesh Model', icon: '🧊' },
  docx: { label: 'DOCX', subtext: 'Microsoft Word Document', icon: '📝' },
  txt: { label: 'TXT', subtext: 'Plain Text File', icon: '📄' },
  csv: { label: 'CSV', subtext: 'Comma-Separated Values', icon: '📊' },
  json: { label: 'JSON', subtext: 'Structured JavaScript Object Notation', icon: '💻' },
  jsonl: { label: 'JSONL', subtext: 'JSON Lines Dataset', icon: '💻' },
  tsv: { label: 'TSV', subtext: 'Tab-Separated Values', icon: '📊' },
  parquet: { label: 'PARQUET', subtext: 'Apache Parquet Columnar Data', icon: '🗄️' },
  yaml: { label: 'YAML', subtext: 'YAML Configuration & Data', icon: '⚙️' },
  xml: { label: 'XML', subtext: 'Extensible Markup Language', icon: '📋' },
  mp3: { label: 'MP3', subtext: 'Standard Audio (MPEG-1 Audio Layer 3)', icon: '🎵' },
  wav: { label: 'WAV', subtext: 'Uncompressed Lossless Audio', icon: '🔊' },
  flac: { label: 'FLAC', subtext: 'Free Lossless Audio Codec', icon: '🎧' },
  m4a: { label: 'M4A', subtext: 'High-Efficiency AAC Audio', icon: '🎵' },
  ogg: { label: 'OGG', subtext: 'Ogg Vorbis Audio', icon: '🎶' },
  opus: { label: 'OPUS', subtext: 'Low-Latency Opus Voice & Audio', icon: '🎙️' },
  mp4: { label: 'MP4', subtext: 'Universal H.264 / AAC Video', icon: '🎬' },
  webm: { label: 'WEBM', subtext: 'Open WebM Video (VP8/VP9)', icon: '📹' },
  mov: { label: 'MOV', subtext: 'Apple QuickTime Movie', icon: '🎥' },
  avi: { label: 'AVI', subtext: 'Audio Video Interleave Container', icon: '📼' },
